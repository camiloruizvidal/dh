	...
	*/
	function service($data){
		...
		if ($rm == 'POST') {
			...
			header("Content-Type: text/html; charset=ISO-8859-1\r\n");
			print "Este servicio no proporciona una descripcion Web";
		}
	}
    ...
    */
    function webDescription(){
		...
		<div class=content>
			...
			<div class=nav>
				<p>Ingrese al <a href="'.$PHP_SELF.'?wsdl">WSDL</a> de los servicios.
				Haga click en los servicios para ver mas detalles.</p>
				<ul>';
